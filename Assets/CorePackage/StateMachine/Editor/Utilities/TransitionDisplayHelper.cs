...
namespace CorePackage.StateMachine.Editor
{
    internal class TransitionDisplayHelper
    {
        ...
        internal bool Display(ref Rect position)
        {
            ...
            // Buttons
            {
                static bool Button(Rect pos, string icon) => GUI.Button(pos, EditorGUIUtility.IconContent(icon));

                Rect buttonRect = new(x: rect.width - 25, y: rect.y + 5, width: 30, height: 18);
