...
{
    /// <summary>
    /// Event Channel with a single parameter for value or sender. Easy to connect in the inspector for basic values and useful for complex data like EventArgs.
    /// </summary>
